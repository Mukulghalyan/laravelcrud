...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-dark py-3">
        <h3 class="text-white text-center">Task edit</h3>
    </div>
    <div class="container">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update',$product->id) }}" method="post">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input value="{{ old('name',$product->name) }}" type="text" class="@error('name') is-invalid @enderror form-control-lg form-control" placeholder="Title" name="name">
                                @error('name')
